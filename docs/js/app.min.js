...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./map */ \"./app/js/map.js\");\n/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ \"./node_modules/imask/esm/index.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\n\n\nswiper__WEBPACK_IMPORTED_MODULE_2__[\"default\"].use([swiper__WEBPACK_IMPORTED_MODULE_2__[\"Navigation\"], swiper__WEBPACK_IMPORTED_MODULE_2__[\"Pagination\"]]);\nvar params = {\n  paginationUpdate: function paginationUpdate(e, paginationEl) {\n    var bullets = document.querySelectorAll('.blog-pagination .swiper-pagination-bullet');\n    document.querySelector('.blog .swiper-pages').innerHTML = '';\n\n    for (var i = 0; i < bullets.length; i++) {\n      document.querySelector('.blog .swiper-pages').innerHTML += '<button class=\"slider-button\">' + (i + 1) + '</button>';\n    }\n\n    var blogPagination = document.body.querySelectorAll('.blog .swiper-pages button');\n\n    for (var _i = 0; _i < blogPagination.length; _i++) {\n      blogPagination[_i].addEventListener('click', function (event) {\n        var slider = document.querySelector('.blog-slider').swiper;\n\n        var index = _toConsumableArray(event.target.parentElement.children).indexOf(event.target);\n\n        slider.slideTo(index);\n        event.preventDefault();\n      });\n    }\n\n    var pages = document.querySelectorAll('.blog .slider-button');\n\n    for (var _i2 = 0; _i2 < bullets.length; _i2++) {\n      if (bullets[_i2].hasClass('swiper-pagination-bullet-active')) {\n        pages[_i2].classList.add('active');\n      }\n    }\n  }\n};\nvar service_params = {\n  paginationUpdate: function paginationUpdate(e, paginationEl) {\n    var bullets = document.querySelectorAll('section.services .swiper-pagination-bullet');\n    document.querySelector('section.services .swiper-pages').innerHTML = '';\n\n    for (var i = 0; i < bullets.length; i++) {\n      document.querySelector('section.services .swiper-pages').innerHTML += '<button class=\"slider-button\">' + (i + 1) + '</button>';\n    }\n\n    var servicePagination = document.body.querySelectorAll('section.services .swiper-pages button');\n\n    for (var _i3 = 0; _i3 < servicePagination.length; _i3++) {\n      servicePagination[_i3].addEventListener('click', function (event) {\n        var slider = document.querySelector('.services-slider').swiper;\n\n        var index = _toConsumableArray(event.target.parentElement.children).indexOf(event.target);\n\n        slider.slideTo(index);\n        event.preventDefault();\n      });\n    }\n\n    var pages = document.querySelectorAll('section.services .slider-button');\n\n    for (var _i4 = 0; _i4 < bullets.length; _i4++) {\n      if (bullets[_i4].hasClass('swiper-pagination-bullet-active')) {\n        pages[_i4].classList.add('active');\n      }\n    }\n  }\n};\nvar trainDistance = 190;\nvar phoneMask = document.querySelectorAll('[type=\"tel\"]');\nphoneMask.forEach(function (element) {\n  return Object(imask__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(element, {\n    mask: '+{7} (000) 000-00-00'\n  });\n});\n\nfunction initTrainEvent() {\n  if (window.scrollY > trainDistance) {\n    document.querySelector('.train').classList.add('fade-in');\n  } else {\n    document.querySelector('.train').classList.remove('fade-in');\n  }\n}\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  initTrainEvent();\n  Object(_map__WEBPACK_IMPORTED_MODULE_0__[\"initMap\"])();\n});\nvar train = document.querySelector('.train');\ntrain.addEventListener('click', function (event) {\n  window.scrollTo({\n    top: 0,\n    behavior: \"smooth\"\n  });\n});\n\nfunction filterBlogSlider(filterName) {\n  if (filterName) {\n    var blogSiblingsSlides = document.querySelectorAll('.blog-slider .blog-slide:not([data-filter=\"' + filterName + '\"])');\n\n    for (var i = 0; i < blogSiblingsSlides.length; i++) {\n      blogSiblingsSlides[i].classList.add('non-swiper-slide');\n      blogSiblingsSlides[i].classList.remove('swiper-slide');\n    }\n\n    var blogSlides = document.querySelectorAll('.blog-slider .blog-slide[data-filter=\"' + filterName + '\"]');\n\n    for (var _i5 = 0; _i5 < blogSlides.length; _i5++) {\n      blogSlides[_i5].classList.add('swiper-slide');\n\n      blogSlides[_i5].classList.remove('non-swiper-slide');\n    }\n  } else {\n    var _blogSlides = document.querySelectorAll('.blog-slider .blog-slide');\n\n    for (var _i6 = 0; _i6 < _blogSlides.length; _i6++) {\n      _blogSlides[_i6].classList.add('swiper-slide');\n\n      _blogSlides[_i6].classList.remove('non-swiper-slide');\n    }\n  }\n\n  var slider = document.querySelector('.blog-slider').swiper;\n  slider.destroy(true, true);\n  var slider_columns = document.querySelector('.blog-slider').hasClass('column-1');\n  var columns = 1;\n\n  if (!slider_columns) {\n    columns = 2;\n  }\n\n  if (document.querySelectorAll('.blog-slider .swiper-slide').length > 3) {\n    new swiper__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.blog-slider', {\n      on: params,\n      slidesPerView: 3,\n      slidesPerColumn: 2,\n      spaceBetween: 30,\n      breakpoints: {\n        0: {\n          slidesPerView: 1,\n          spaceBetween: 20,\n          slidesPerColumn: 1\n        },\n        1024: {\n          slidesPerView: 2,\n          slidesPerColumn: columns,\n          spaceBetween: 30\n        },\n        1366: {\n          slidesPerView: 3,\n          slidesPerColumn: columns,\n          spaceBetween: 30\n        }\n      },\n      pagination: {\n        el: '.blog-slider .swiper-pagination',\n        clickable: true\n      },\n      slidesPerColumnFill: 'row',\n      navigation: {\n        nextEl: '.blog-next',\n        prevEl: '.blog-prev'\n      }\n    });\n  } else {\n    new swiper__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.blog-slider', {\n      on: params,\n      slidesPerView: 3,\n      spaceBetween: 30,\n      breakpoints: {\n        0: {\n          slidesPerView: 1,\n          spaceBetween: 20,\n          slidesPerColumn: 1\n        },\n        1024: {\n          slidesPerView: 2,\n          slidesPerColumn: columns,\n          spaceBetween: 30\n        },\n        1366: {\n          slidesPerView: 3,\n          slidesPerColumn: columns,\n          spaceBetween: 30\n        }\n      },\n      slidesPerColumnFill: 'row',\n      pagination: {\n        el: '.blog-slider .swiper-pagination',\n        clickable: true\n      },\n      navigation: {\n        nextEl: '.blog-next',\n        prevEl: '.blog-prev'\n      }\n    });\n  }\n}\n\nfunction filterServiceSlider(filterName) {\n  if (filterName) {\n    var serviceSiblingsSlides = document.querySelectorAll('.services-slider .service-slide:not([data-filter=\"' + filterName + '\"])');\n\n    for (var i = 0; i < serviceSiblingsSlides.length; i++) {\n      serviceSiblingsSlides[i].classList.add('non-swiper-slide');\n      serviceSiblingsSlides[i].classList.remove('swiper-slide');\n    }\n\n    var serviceSlides = document.querySelectorAll('.services-slider .service-slide[data-filter=\"' + filterName + '\"]');\n\n    for (var _i7 = 0; _i7 < serviceSlides.length; _i7++) {\n      serviceSlides[_i7].classList.add('swiper-slide');\n\n      serviceSlides[_i7].classList.remove('non-swiper-slide');\n    }\n  } else {\n    var _serviceSlides = document.querySelectorAll('.services-slider .service-slide');\n\n    for (var _i8 = 0; _i8 < _serviceSlides.length; _i8++) {\n      _serviceSlides[_i8].classList.add('swiper-slide');\n\n      _serviceSlides[_i8].classList.remove('non-swiper-slide');\n    }\n  }\n\n  var slider = document.querySelector('.services-slider').swiper;\n  slider.destroy(true, true);\n  new swiper__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.services-slider', {\n    on: service_params,\n    breakpoints: {\n      0: {\n        slidesPerView: 1,\n        spaceBetween: 20,\n        slidesPerColumn: 1\n      },\n      1024: {\n        slidesPerView: 2,\n        slidesPerColumn: 2,\n        spaceBetween: 30\n      },\n      1366: {\n        slidesPerView: 2,\n        slidesPerColumn: 2,\n        spaceBetween: 30\n      }\n    },\n    slidesPerColumnFill: 'row',\n    pagination: {\n      el: 'section.services .swiper-pagination',\n      clickable: true\n    },\n    navigation: {\n      nextEl: '.service-next',\n      prevEl: '.service-prev'\n    }\n  });\n}\n\nvar blogFilter = document.querySelectorAll('.filter.blog a');\n\nfor (var i = 0; i < blogFilter.length; i++) {\n  blogFilter[i].addEventListener('click', function (event) {\n    Array.prototype.forEach.call(blogFilter, function (el, i) {\n      el.classList.remove('active');\n    });\n    event.target.classList.add('active');\n    filterBlogSlider(event.target.getAttribute('data-category'));\n    event.preventDefault();\n  });\n}\n\nvar loadMore = document.querySelectorAll('.load-more');\n\nfor (var _i9 = 0; _i9 < loadMore.length; _i9++) {\n  loadMore[_i9].addEventListener('click', function (event) {\n    document.querySelector('.read').style.display = 'block';\n    event.target.style.display = 'none';\n    event.preventDefault();\n  });\n}\n\nvar burger = document.querySelector('.burger');\nburger.addEventListener('click', function (event) {\n  document.body.classList.toggle('menu-opened');\n  event.preventDefault();\n});\nvar closeBurger = document.querySelector('.menu-close_button');\ncloseBurger.addEventListener('click', function (event) {\n  document.body.classList.remove('menu-opened');\n  event.preventDefault();\n});\n\nfunction index(el) {\n  if (!el) return -1;\n  var i = 0;\n\n  do {\n    i++;\n  } while (el = el.previousElementSibling);\n\n  return i;\n}\n\nvar exampleFilter = document.querySelectorAll('.filter.example a');\n\nfor (var _i10 = 0; _i10 < exampleFilter.length; _i10++) {\n  exampleFilter[_i10].addEventListener('click', function (event) {\n    Array.prototype.forEach.call(exampleFilter, function (el, i) {\n      el.classList.remove('active');\n    });\n    event.target.classList.add('active');\n    var pages = document.querySelectorAll('.pages .page');\n    var sibling_element = Array.prototype.filter.call(pages[index(event.target) - 1].parentNode.children, function (child) {\n      return child !== pages[index(event.target) - 1];\n    });\n\n    for (var _i11 = 0; _i11 < sibling_element.length; _i11++) {\n      sibling_element[_i11].style.display = 'none';\n    }\n\n    pages[index(event.target) - 1].style.display = 'block';\n    event.preventDefault();\n  });\n}\n\nvar serviceFilter = document.querySelectorAll('.filter.service a');\n\nfor (var _i12 = 0; _i12 < serviceFilter.length; _i12++) {\n  serviceFilter[_i12].addEventListener('click', function (event) {\n    Array.prototype.forEach.call(serviceFilter, function (el, i) {\n      el.classList.remove('active');\n    });\n    event.target.classList.add('active');\n    filterServiceSlider(event.target.getAttribute('data-category'));\n    event.preventDefault();\n  });\n}\n\nvar formInputs = document.querySelectorAll('.form-input input');\n\nfor (var _i13 = 0; _i13 < formInputs.length; _i13++) {\n  formInputs[_i13].addEventListener('focus', function (event) {\n    event.target.parentNode.classList.add('active');\n    event.preventDefault();\n  });\n\n  formInputs[_i13].addEventListener('blur', function (event) {\n    if (event.target.value === '') {\n      event.target.parentNode.classList.remove('active');\n    }\n\n    event.preventDefault();\n  });\n}\n\nwindow.addEventListener('scroll', function () {\n  initTrainEvent();\n});\n\n//# sourceURL=webpack:///./app/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\nswiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"].use([swiper__WEBPACK_IMPORTED_MODULE_0__[\"Navigation\"], swiper__WEBPACK_IMPORTED_MODULE_0__[\"Pagination\"]]);\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.team-slider', {\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.team-next',\n    prevEl: '.team-prev'\n  },\n  pagination: {\n    el: '.team-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\n\nElement.prototype.hasClass = function (className) {\n  return this.className && new RegExp(\"(^|\\\\s)\" + className + \"(\\\\s|$)\").test(this.className);\n};\n\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.work-slider', {\n  on: {\n    paginationUpdate: function paginationUpdate(e, paginationEl) {\n      var bullets = document.querySelectorAll('.work-pagination .swiper-pagination-bullet');\n      var numbers = document.querySelectorAll('.work-number');\n\n      for (var i = 0; i < bullets.length; i++) {\n        if (bullets[i].hasClass('swiper-pagination-bullet-active')) {\n          for (var k = 0; k < numbers.length; k++) {\n            numbers[k].innerHTML = '0' + (i + 1);\n          }\n        }\n      }\n    }\n  },\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.work-prev',\n    prevEl: '.work-next'\n  },\n  pagination: {\n    el: '.work-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.why-slider', {\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.why-prev',\n    prevEl: '.why-next'\n  },\n  pagination: {\n    el: '.why-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.news-slider', {\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.news-prev',\n    prevEl: '.news-next'\n  },\n  pagination: {\n    el: '.news-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.banks-slider', {\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.banks-next',\n    prevEl: '.banks-prev'\n  },\n  pagination: {\n    el: '.banks-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.we-slider', {\n  on: {\n    paginationUpdate: function paginationUpdate(e, paginationEl) {\n      var bullets = document.querySelectorAll('.we-pagination .swiper-pagination-bullet');\n      var numbers = document.querySelectorAll('.we-number');\n\n      for (var i = 0; i < bullets.length; i++) {\n        if (bullets[i].hasClass('swiper-pagination-bullet-active')) {\n          for (var k = 0; k < numbers.length; k++) {\n            numbers[k].innerHTML = '0' + (i + 1);\n          }\n        }\n      }\n    }\n  },\n  spaceBetween: 30,\n  speed: 500,\n  navigation: {\n    nextEl: '.we-next',\n    prevEl: '.we-prev'\n  },\n  pagination: {\n    el: '.we-pagination',\n    clickable: true\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    900: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    },\n    1366: {\n      spaceBetween: 30,\n      slidesPerView: 'auto'\n    }\n  }\n});\nvar params = {\n  paginationUpdate: function paginationUpdate(e, paginationEl) {\n    var bullets = document.querySelectorAll('.blog-pagination .swiper-pagination-bullet');\n    document.querySelector('.blog .swiper-pages').innerHTML = '';\n\n    for (var i = 0; i < bullets.length; i++) {\n      document.querySelector('.blog .swiper-pages').innerHTML += '<button class=\"slider-button\">' + (i + 1) + '</button>';\n    }\n\n    var blogPagination = document.body.querySelectorAll('.blog .swiper-pages button');\n\n    for (var _i = 0; _i < blogPagination.length; _i++) {\n      blogPagination[_i].addEventListener('click', function (event) {\n        var slider = document.querySelector('.blog-slider').swiper;\n\n        var index = _toConsumableArray(event.target.parentElement.children).indexOf(event.target);\n\n        slider.slideTo(index);\n        event.preventDefault();\n      });\n    }\n\n    var pages = document.querySelectorAll('.blog .slider-button');\n\n    for (var _i2 = 0; _i2 < bullets.length; _i2++) {\n      if (bullets[_i2].hasClass('swiper-pagination-bullet-active')) {\n        pages[_i2].classList.add('active');\n      }\n    }\n  }\n};\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.blog-slider:not(.column-1)', {\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20,\n      slidesPerColumn: 1\n    },\n    1024: {\n      slidesPerView: 2,\n      slidesPerColumn: 2,\n      spaceBetween: 30\n    },\n    1366: {\n      slidesPerView: 3,\n      slidesPerColumn: 2,\n      spaceBetween: 30\n    }\n  },\n  pagination: {\n    el: '.blog-slider .swiper-pagination',\n    clickable: true\n  },\n  slidesPerColumnFill: 'row',\n  navigation: {\n    nextEl: '.blog-next',\n    prevEl: '.blog-prev'\n  },\n  on: params\n});\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.blog-slider.column-1', {\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20\n    },\n    1024: {\n      slidesPerView: 2,\n      spaceBetween: 30\n    },\n    1366: {\n      slidesPerView: 3,\n      spaceBetween: 30\n    }\n  },\n  pagination: {\n    el: '.blog-slider .swiper-pagination',\n    clickable: true\n  },\n  slidesPerColumnFill: 'row',\n  navigation: {\n    nextEl: '.blog-next',\n    prevEl: '.blog-prev'\n  },\n  on: params\n});\nvar service_params = {\n  paginationUpdate: function paginationUpdate(e, paginationEl) {\n    var bullets = document.querySelectorAll('section.services .swiper-pagination-bullet');\n    document.querySelector('section.services .swiper-pages').innerHTML = '';\n\n    for (var i = 0; i < bullets.length; i++) {\n      document.querySelector('section.services .swiper-pages').innerHTML += '<button class=\"slider-button\">' + (i + 1) + '</button>';\n    }\n\n    var servicePagination = document.body.querySelectorAll('section.services .swiper-pages button');\n\n    for (var _i3 = 0; _i3 < servicePagination.length; _i3++) {\n      servicePagination[_i3].addEventListener('click', function (event) {\n        var slider = document.querySelector('.services-slider').swiper;\n\n        var index = _toConsumableArray(event.target.parentElement.children).indexOf(event.target);\n\n        slider.slideTo(index);\n        event.preventDefault();\n      });\n    }\n\n    var pages = document.querySelectorAll('section.services .slider-button');\n\n    for (var _i4 = 0; _i4 < bullets.length; _i4++) {\n      if (bullets[_i4].hasClass('swiper-pagination-bullet-active')) {\n        pages[_i4].classList.add('active');\n      }\n    }\n  }\n};\nnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.services-slider', {\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 20,\n      slidesPerColumn: 1\n    },\n    1024: {\n      slidesPerView: 2,\n      slidesPerColumn: 2,\n      spaceBetween: 30\n    },\n    1366: {\n      slidesPerView: 2,\n      slidesPerColumn: 2,\n      spaceBetween: 30\n    }\n  },\n  navigation: {\n    nextEl: '.service-next',\n    prevEl: '.service-prev'\n  },\n  pagination: {\n    el: 'section.services .swiper-pagination',\n    clickable: true\n  },\n  slidesPerColumnFill: 'row',\n  on: service_params\n});\n\n//# sourceURL=webpack:///./app/js/slider.js?");
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./app/js/app.js ./app/js/map.js ./app/js/slider.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! C:\\Users\\sergey\\WebstormProjects\\yurik\\app\\js\\app.js */\"./app/js/app.js\");\n__webpack_require__(/*! C:\\Users\\sergey\\WebstormProjects\\yurik\\app\\js\\map.js */\"./app/js/map.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\sergey\\WebstormProjects\\yurik\\app\\js\\slider.js */\"./app/js/slider.js\");\n\n\n//# sourceURL=webpack:///multi_./app/js/app.js_./app/js/map.js_./app/js/slider.js?");
